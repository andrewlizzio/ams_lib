...
/// will occur in the reverse order so xalloc_init_destroy is called last. This way,
...
static XallocInitDestroy xalloc_init_destroy;
...
/// Free all unused heap
void xalloc_clean();

size_t xalloc_get_total_memory_used();
