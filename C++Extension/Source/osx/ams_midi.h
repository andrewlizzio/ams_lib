...
private:
    // Variables
    static AUGraph* au_graph;
    static AudioUnit* au_synth;

    // Helper Functions
    static bool c_is_device_valid();
    static bool c_out_message(unsigned char arg0, unsigned char arg1, unsigned char arg2);
    static bool c_edit_channel_controller(unsigned char channel, unsigned char cnum, unsigned char cval);
