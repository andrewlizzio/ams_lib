...
module AMS::Geometry
  class << self
    ...
    # @param [Geom::Point3d] p0 First point origin.
    # @param [Geom::Point3d] p1 First point target.
    # @param [Geom::Point3d] p2 Second point target.
    # @param [Geom::Point3d] p3 Second point origin.
    # @return [Geom::Point3d]
    # @since 3.5.0
    def calc_cubic_bezier_point(ratio, p0, p1, p2, p3)
    end
    ...
    # @since 3.5.0
    def calc_cubic_bezier_slope(ratio, p0, p1, p2, p3)
    end
    ...
    # Scale matrix axes.
    # @param [Array<Numeric>, Geom::Transformation] matrix
    # @param [Array<Numeric>, Geom::Vector3d] scale
    ...
    # @param [Array<Numeric>, Geom::Vector3d] vector1
    # @param [Array<Numeric>, Geom::Vector3d] vector2
    # @return [Geom::Vector3d]
    # @since 3.6.0
    ...
    # @param [Array<Geom::Point3d>] points
    # @return [Array<Geom::Point3d>] An array of sorted points.
    # @note A polygon must be convex for the points to be sorted correctly.
    # @note If all points are collinear, then they won't be sorted and an array
    #   of unique points will be returned.
    ...
    # @return [Geom::Transformation]
    # @since 3.6.0
    def extract_matrix_w_factor(transformation)
    end
    ...
    # Rotate a transformation matrix so that its X-axis aligns with a directing
    # vector.
    # @param [Geom::Transformation] transformation
    # @param [Geom::Vector] direction
    # @return [Geom::Transformation]
    # @since 3.5.0
    def rotate_matrix_xaxis_to_dir(transformation, direction)
    end

    # Rotate a transformation matrix so that its Y-axis aligns with a directing
    # vector.
    # @param [Geom::Transformation] transformation
    # @param [Geom::Vector] direction
    # @return [Geom::Transformation]
    # @since 3.5.0
    def rotate_matrix_yaxis_to_dir(transformation, direction)
    end
