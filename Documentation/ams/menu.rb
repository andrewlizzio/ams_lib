...
module AMS::Menu
  class << self
    ...
    # @note A return value of zero implies the menu item is a separator.
    # @param [Fixnum] handle A handle to a valid menu or sub-menu.
    # @param [Fixnum] index
    # @return [Fixnum, nil] Menu item identifier if successful or +-1+ if not.
    ...
    # @param [Fixnum] index
    # @return [Boolean] True if grayed/disabled; false if enabled.
    # @since 3.6.0
