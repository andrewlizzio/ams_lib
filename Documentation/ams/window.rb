...
module AMS::Window
  class << self
    ...
    # @return [Fixnum, nil] A handle to a window with keyboard focus.
    # @see https://msdn.microsoft.com/en-us/library/windows/desktop/ms646294(v=vs.85).aspx GetFocus
    # @since 3.6.0
    ...
    # @param [Fixnum] handle Handle to a valid window.
    # @return [Fixnum] A handle to an original window with keyboard focus.
    # @see https://msdn.microsoft.com/en-us/library/windows/desktop/ms646312(v=vs.85).aspx SetFocus
    # @since 3.6.0
    ...
    # @param [Fixnum] index
    # @return [Fixnum] Window long.
    # @see https://msdn.microsoft.com/en-us/library/windows/desktop/ms633580(v=vs.85).aspx GetClassLong
    # @since 3.6.0
    ...
    # @param [Fixnum] long
    # @return [Fixnum] Previous window long.
    # @see https://msdn.microsoft.com/en-us/library/windows/desktop/ms633588(v=vs.85).aspx SetClassLong
    # @since 3.6.0
    ...
    # @param [Fixnum] handle Handle to a valid window.
    # @param [Sketchup::Color] color Background color
    # @param [Boolean] b_activate Whether to activate the window.
    # @return [Boolean] success
    # @since 3.6.0
